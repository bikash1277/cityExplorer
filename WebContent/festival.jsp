...
<html>
  <head>
    ...
    <title>Cuttack Festivals page</title>
								...
								<td style="background-repeat: repeat-x;" class="headermenu"
									...
									<div align="center">
										<a href="home1.html">HOME</a> <img src="Images\link_sep.jpg"
											...
											height="60" hspace="30"> <a href="festival.jsp">GALLERY</a>
...
<a href="javascript:OpenFrame(0)" class=dd><img src="./Images/Rathyatra.jpg" width="110" height="53" BORDER="0"></a></td><td> 
<a href="javascript:OpenFrame(1)" class=dd><img src="./Images/Durgapuja.jpg" width="110" height="53" BORDER="0"></a></td><td> 
<a href="javascript:OpenFrame(2)" class=dd><img src="./Images/Kartik purnima.jpg" width="110" height="53" BORDER="0"></a></td><td> 
<a href="javascript:OpenFrame(3)" class=dd><img src="./Images/Ganeshpuja.jpg" width="110" height="53" BORDER="0"></a></td></tr> 
</table> 
                        <table width="100%" border="0" cellspacing="4" cellpadding="0"> 
                          <tr valign="middle"> 
                            <td align="center" width="15%"><div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#000000"> 
                                <a href="javascript:OpenFrame(0)" class=dd>Rathyatra </a></font></b></font></div></td> 
                            ...
                            <td align="center" width="12%"><div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><strong><font color="#808040"> 
                                <a href="javascript:OpenFrame(1)" class=dd>Durgapuja </a></font></strong></font></div></td> 
                            ...
                            <td width="25%" align="center"><div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#808040"> 
                                <a href="javascript:OpenFrame(2)" class=dd>Kartik purnima </a></font></b></font></div></td> 
                            <td width="24%" align="center"><div align="left"><font size="1" face="Verdana, Arial, Helvetica, sans-serif"><b><font color="#808040"> 
                                <a href="javascript:OpenFrame(3)" class=dd>Ganeshpuja </a></font></b></font></div></td> 
                          </tr>                         
<img src="Images\rgt_sep.jpg">
	<img src="Images\rgt_sep.jpg">
	<img src="Images\rgt_sep.jpg">
