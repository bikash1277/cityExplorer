	...
	<table align="center" width="150%">
		<tr>
			...
			<td>
				<table>
					<tr>
						<td><img src="Images\Seven.jpg" width="250" height="200" /></td>
						<td><img src="Images\Barabati_Fort_Cuttack.jpg" height="200" width="250" /></td>
						<td><img src="Images\state_museum.jpg" height="200" width="250" /></td>
						<td><img src="Images\Odisha-HC.jpg" height="200" width="250" /></td>
					</tr>
					<tr>
						<td><h3><font color="White">Ravenshaw University</h3></td>
						<td><h3><font color="White">Barabati Fort</h3></td>
						<td><h3><font color="White">Odisha Maritime Museum</h3></td>
						<td><h3><font color="White">High Court Cuttack</h3></td>
					</tr>
				</table>
			</td>
			<td align="right">
						...
						<tr>
							<td><marquee direction="up" scrolldelay="250"
									...
									<div
										...
										Events@Cuttack On 05-03-2020 <br>Food Festival @ <img
