	...
	<td align="right" valign="top" width="776"><div>
                          <div class="innner_bodybg" style="width: 779px;">
                            <div style="background-image: url(images/Inner_heading_bg.gif); background-repeat: repeat-x; height: 31px;">
                              <div style="height: 31px; width: 37px; float: left;"><img src="Consultants_files/Inner_heading_img.gif"></div>
    <div style="float: left; padding-top: 8px; font-family: arial; font-size: 14px; color: rgb(0, 0, 0); font-weight: bold;">Emergency_Contacts</div>
                            </div>
                            <div>
                              <table align="center" cellpadding="0" cellspacing="0" width="776">
                                
                                <tbody><tr>
                                  <td class="inner_border" align="left" valign="top" width="194">NATIONAL EMERGENCY NUMBER:112 <br>
POLICE: 100<br>
FIRE: 101<br>
POLICE: 100<br>
AMBULANCE: 102<br>
Disaster Management Services: 108<br>
Women Helpline: 1091<br>
Railway Enquiry: 139<br>
Road Accident Emergency Service: 1073<br>
Tourist Helpline: 1363<br>
Relief Commissioner For Natural Calamities: 1070<br>
Kisan Call Centre: 1551<br>
Senior Citizen Helpline: 1091</td>
